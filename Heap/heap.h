...
/*Cambia la función de comparación/prioridad de un heap, y lo
 *Reordena de tal forma que ahora se comporta teniendo en cuenta 
 *su nueva función de comparación.
 *Pre: el heap fue creado.
 */
void cambiar_cmp_heap(heap_t *heap, cmp_func_t cmp_nuevo);
